...
- compare_periods: сравнить метрику в двух периодах (delta и ratio)
...
def _write_trace_jsonl(run_id: str, record: dict):
    """Дописать одну запись в trace.jsonl."""
    ...
    *,
    ...
    for step in range(1, max_iter + 1):
        ...
        if not msg.tool_calls:
            ...
            _write_trace_jsonl(run_id, {"step": step, "final": msg.content})
            return _finish(
                {
                    "answer": msg.content,
                    "structured": None,
