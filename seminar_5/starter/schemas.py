...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Сравнить значение макро-метрики (курс валюты, ключевая ставка, "
                "инфляция, безработица) в двух периодах. Возвращает значения "
                "для обоих периодов, delta (разность) и ratio (отношение). "
                "Удобно для вопросов вида «во сколько раз вырос...» или "
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "period_a": {
                        "type": "string",
                        "description": "Первый период: YYYY-MM-DD (для курсов/ставки) или YYYY-MM (для инфляции/безработицы)",
                    },
                    "period_b": {
                        "type": "string",
                        "description": "Второй период: YYYY-MM-DD или YYYY-MM",
                    },
                },
